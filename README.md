...
- [陈斌](http://ai.hitsz.edu.cn/info/1030/1076.htm)
  <!-- TOML-ITEM: id="review-陈斌-1" -->
  - “大陈斌”，研究员，和这个[陈斌](https://homepage.hit.edu.cn/BinChen)是两个老师哦。
  - 人工智能班专属老师（存疑）。老师思路非常发散，讲究一个“想到什么讲什么”。有时老师语速快得听不懂，所以要往前坐。老师会认真记住每一位同学的名字。
  - 老师随机来到某位同学面前，亲切问你：听懂了没？如果你（无论是眼神还是别的什么，老师看出来你听不懂了），老师就会调动其他同学和你自己为你讲解。
  - 如果你表示听懂了，老师会热情邀请你进行讲解。
  - 总之互动性很强；签到会提前在QQ群说。（可能是前一天晚上，也可能是上课前几分钟）
...
2026春：主要负责老师是仇老师，她已经迭代了N版实验框架（包含四个MIT的实验+一个基于FUSE的Ext2）。
